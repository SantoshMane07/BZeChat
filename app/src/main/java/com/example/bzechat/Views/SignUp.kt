...
import com.example.bzechat.ViewModels.SignUpViewModel
import com.example.bzechat.databinding.ActivitySignUpBinding
                ...
                if (email.isEmailValid() && phone.isPhoneValid() && cpassword.equals(password) && password.length>5){
                        ...
                        mauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener {
                            if (it.isSuccessful){
                                ...
                                val user = User(mauth.currentUser!!.uid,name,phone,email,imageUriString,"Hey! there Iam using Bzechat")
